...
SOURCE = ROOT / "assets/social/houthi-mocha-bab-el-mandeb-central.png"
OUTPUT = ROOT / "assets/social/houthi-mocha-bab-el-mandeb-instagram.jpg"
PREVIEW = ROOT / "assets/social/houthi-mocha-bab-el-mandeb-preview-390.jpg"
W, H = 1080, 1350
...
d.text((56, 75), "YEMEN · MAR ROSSO · ENERGIA", font=font(26, True), fill=GOLD)
title="GLI HOUTHI PRENDONO MOCHA"; d.text((56, 120), title, font=fit(d,title,968,48,38), fill=WHITE)
sub="Il corridoio alternativo a Hormuz entra nel fronte"; d.text((56, 190), sub, font=fit(d,sub,968,31,22,False), fill=MUTED)
...
d.rectangle((78,746,1002,798), fill=BOX); caption="MOCHA: IL FRONTE AVANZA VERSO LO STRETTO"; d.text((92,757), caption, font=fit(d,caption,890,25,18), fill=WHITE)
d.rectangle((56,830,1024,930), fill=BOX, outline="#32414b", width=2); d.text((82,842), "IL MECCANISMO", font=font(20,True), fill=GOLD)
mechanism = "HORMUZ BLOCCA L’EST. MOCHA PORTA LA GUERRA SULLA ROTTA OCCIDENTALE."; d.text((82,875), mechanism, font=fit(d,mechanism,916,22,15), fill=WHITE)
