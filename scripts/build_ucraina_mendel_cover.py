...
SOURCE = ROOT / "assets/social/ucraina-mendel-central.png"
OUTPUT = ROOT / "assets/social/ucraina-mendel-sanzioni-instagram.jpg"
PREVIEW = ROOT / "assets/social/ucraina-mendel-sanzioni-preview-390.jpg"
W, H = 1080, 1350
...
d.text((56, 75), "UCRAINA · SANZIONI · DISSENSO · POTERE", font=font(25, True), fill=GOLD)
title = "LA LISTA NERA ENTRA NEL PALAZZO"; d.text((56, 120), title, font=fit(d, title, 968, 47, 29), fill=WHITE)
sub = "Dieci anni di sanzioni contro l’ex portavoce"; d.text((56, 190), sub, font=fit(d, sub, 968, 31, 21, False), fill=MUTED)
...
d.rectangle((78,746,1002,798), fill=BOX); caption = "RICOSTRUZIONE EDITORIALE: IL DECRETO TRASFORMA L’ACCUSA IN BLOCCO"; d.text((92,757), caption, font=fit(d, caption, 890, 22, 14), fill=WHITE)
d.rectangle((56,830,1024,930), fill=BOX, outline="#32414b", width=2); d.text((82,842), "IL MECCANISMO", font=font(20,True), fill=GOLD)
line1 = "L’ACCUSA È AMMINISTRATIVA."; line2 = "IL BLOCCO PATRIMONIALE È IMMEDIATO."
d.text((82,875), line1, font=fit(d, line1, 916, 21, 15), fill=WHITE); d.text((82,899), line2, font=fit(d, line2, 916, 21, 15), fill=WHITE)
