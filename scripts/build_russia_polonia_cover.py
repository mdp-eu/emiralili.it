...
SOURCE = ROOT / "assets/social/russia-polonia-confine-central.png"
OUTPUT = ROOT / "assets/social/russia-polonia-confine-nato-instagram.jpg"
PREVIEW = ROOT / "assets/social/russia-polonia-confine-nato-preview-390.jpg"
W, H = 1080, 1350
...
d.text((56, 75), "RUSSIA · UCRAINA · POLONIA · NATO", font=font(25, True), fill=GOLD)
title = "MOSCA COLPISCE A 800 METRI DALLA NATO"; d.text((56, 120), title, font=fit(d, title, 968, 44, 28), fill=WHITE)
sub = "Il confine polacco entra nella guerra logistica"; d.text((56, 190), sub, font=fit(d, sub, 968, 30, 21, False), fill=MUTED)
...
d.rectangle((78,746,1002,798), fill=BOX); caption = "RICOSTRUZIONE EDITORIALE: DOROHUSK–YAHODYN, IL VARCO DIVENTA FRONTE"; d.text((92,757), caption, font=fit(d, caption, 890, 22, 14), fill=WHITE)
d.rectangle((56,830,1024,930), fill=BOX, outline="#32414b", width=2); d.text((82,842), "IL MECCANISMO", font=font(20,True), fill=GOLD)
line1 = "MOSCA COLPISCE IL NODO UCRAINO."; line2 = "IL CONFINE NATO ASSORBE IL RISCHIO SENZA ATTIVARE L’ARTICOLO 5."
d.text((82,875), line1, font=fit(d, line1, 916, 19, 15), fill=WHITE); d.text((82,899), line2, font=fit(d, line2, 916, 19, 15), fill=WHITE)
