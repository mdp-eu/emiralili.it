...
SOURCE = ROOT / "assets/social/trump-iran-oil-central.png"
OUTPUT = ROOT / "assets/social/trump-iran-petrolio-instagram.jpg"
PREVIEW = ROOT / "assets/social/trump-iran-petrolio-preview-390.jpg"
W, H = 1080, 1350
...
d.text((56, 75), "STATI UNITI · IRAN · PETROLIO · GUERRA", font=font(25, True), fill=GOLD)
title = "TRUMP NOMINA IL BOTTINO"; d.text((56, 120), title, font=fit(d, title, 968, 50, 32), fill=WHITE)
sub = "Restare in Iran per il petrolio"; d.text((56, 190), sub, font=fit(d, sub, 968, 31, 23, False), fill=MUTED)
...
d.rectangle((78,746,1002,798), fill=BOX); caption = "RICOSTRUZIONE EDITORIALE: IL MODELLO VENEZUELA PROIETTATO SULL’IRAN"; d.text((92,757), caption, font=fit(d, caption, 890, 22, 14), fill=WHITE)
d.rectangle((56,830,1024,930), fill=BOX, outline="#32414b", width=2); d.text((82,842), "IL MECCANISMO", font=font(20,True), fill=GOLD)
line1 = "LA GUERRA APRE IL VARCO."; line2 = "IL CONTROLLO DEI CAMPI CONVERTE LA FORZA IN RENDITA."
d.text((82,875), line1, font=fit(d, line1, 916, 20, 15), fill=WHITE); d.text((82,899), line2, font=fit(d, line2, 916, 20, 15), fill=WHITE)
