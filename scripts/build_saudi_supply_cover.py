...
SOURCE = ROOT / "assets/social/saudi-supply-central.png"
OUTPUT = ROOT / "assets/social/saudi-petrolio-minimo-instagram.jpg"
PREVIEW = ROOT / "assets/social/saudi-petrolio-minimo-preview-390.jpg"
W, H = 1080, 1350
...
d.text((56, 75), "ARABIA SAUDITA · PETROLIO · ROTTE", font=font(25, True), fill=GOLD)
title = "RIYAD PERDE 2,3 MILIONI DI BARILI"; d.text((56, 120), title, font=fit(d, title, 968, 45, 31), fill=WHITE)
sub = "Il doppio stretto svuota il mercato saudita"; d.text((56, 190), sub, font=fit(d, sub, 968, 30, 21, False), fill=MUTED)
...
d.rectangle((78,746,1002,798), fill=BOX); caption = "RICOSTRUZIONE: IMPIANTO, OLEODOTTO E PORTO DIVENTANO UN SOLO FRONTE"; d.text((92,757), caption, font=fit(d, caption, 890, 22, 14), fill=WHITE)
d.rectangle((56,830,1024,930), fill=BOX, outline="#32414b", width=2); d.text((82,842), "IL MECCANISMO", font=font(20,True), fill=GOLD)
mechanism = "HORMUZ BLOCCA L’USCITA A EST. BAB EL-MANDEB E IL MAR ROSSO STRINGONO L’ALTERNATIVA."; d.text((82,875), mechanism, font=fit(d, mechanism, 916, 20, 13), fill=WHITE)
