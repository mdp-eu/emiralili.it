...
SOURCE = ROOT / "assets/social/stargate-uae-central.png"
OUTPUT = ROOT / "assets/social/stargate-uae-data-center-instagram.jpg"
PREVIEW = ROOT / "assets/social/stargate-uae-data-center-preview-390.jpg"
W, H = 1080, 1350
...
d.text((56, 75), "EMIRATI · IRAN · IA · GUERRA", font=font(25, True), fill=GOLD)
title = "STARGATE SCENDE SOTTOTERRA"; d.text((56, 120), title, font=fit(d, title, 968, 48, 34), fill=WHITE)
sub = "La guerra ridisegna l’infrastruttura IA del Golfo"; d.text((56, 190), sub, font=fit(d, sub, 968, 30, 21, False), fill=MUTED)
...
d.rectangle((78,746,1002,798), fill=BOX); caption = "RICOSTRUZIONE: IL COMPUTE DIVENTA INFRASTRUTTURA DA DIFENDERE"; d.text((92,757), caption, font=fit(d, caption, 890, 23, 15), fill=WHITE)
d.rectangle((56,830,1024,930), fill=BOX, outline="#32414b", width=2); d.text((82,842), "IL MECCANISMO", font=font(20,True), fill=GOLD)
mechanism = "CHIP, ENERGIA E DATI SI DISPERSANO TRA BUNKER, MONTAGNE E DIFESA AEREA."; d.text((82,875), mechanism, font=fit(d, mechanism, 916, 21, 14), fill=WHITE)
